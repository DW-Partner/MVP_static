        ...
        function() {
            ...
            e.prototype = {
                ...
                getBestMaskPattern: function() {
                    ...
                    r = 0; r < 8; r++) {
                        this.makeImpl(!0, r);
                        var o = c.getLostPoint(this); (0 == r || t > o) && (t = o, e = r)
                    }
                    return e
                },
                createMovieClip: function(t, e, r) {
                    ...
                    this.make();
                    for (var n = 0; n < this.modules.length; n++) for (var i = 1 * n,
                    a = 0; a < this.modules[n].length; a++) {
                        var s = 1 * a,
                        u = this.modules[n][a];
                        u && (o.beginFill(0, 100), o.moveTo(s, i), o.lineTo(s + 1, i), o.lineTo(s + 1, i + 1), o.lineTo(s, i + 1), o.endFill())
                    }
                    return o
                },
                ...
                setupTypeInfo: function(t, e) {
                    ...
                    o = c.getBCHTypeInfo(r), n = 0; n < 15; n++) {
                        var i = !t && 1 == (o >> n & 1);
            ...
            e.createData = function(t, r, o) {
                for (var a = n.getRSBlocks(t, r), s = new i, u = 0; u < o.length; u++) {
                    var h = o[u];
                    s.put(h.mode, 4),
                    s.put(h.getLength(), c.getLengthInBits(h.mode, t)),
                    h.write(s)
                }
                for (var l = 0,
                u = 0; u < a.length; u++) l += a[u].dataCount;
            ...
            e.createBytes = function(t, e) {
                ...
                a = new Array(e.length), s = new Array(e.length), u = 0; u < e.length; u++) {
                    ...
                    i = Math.max(i, l),
                    a[u] = new Array(h);
                    for (var f = 0; f < a[u].length; f++) a[u][f] = 255 & t.buffer[f + o];
                    o += h;
                    var d = c.getErrorCorrectPolynomial(l),
                    g = new r(a[u], d.getLength() - 1),
                    p = g.mod(d);
                ...
                for (var m = 0,
                f = 0; f < e.length; f++) m += e[f].totalCount;
                for (var _ = new Array(m), w = 0, f = 0; f < n; f++) for (var u = 0; u < e.length; u++) f < a[u].length && (_[w++] = a[u][f]);
                for (var f = 0; f < i; f++) for (var u = 0; u < e.length; u++) f < s[u].length && (_[w++] = s[u][f]);
                return _
            };
            for (var h = {
                MODE_NUMBER: 1,
            ...
            c = {
                ...
                getLostPoint: function(t) {
                    ...
                    for (var l = 0,
                    n = 0; n < e; n++) for (var o = 0; o < e; o++) t.isDark(o, n) && l++;
            ...
            g = 0; g < 8; g++) d.EXP_TABLE[g] = 1 << g;
            for (var g = 8; g < 256; g++) d.EXP_TABLE[g] = d.EXP_TABLE[g - 4] ^ d.EXP_TABLE[g - 5] ^ d.EXP_TABLE[g - 6] ^ d.EXP_TABLE[g - 8];
            for (var g = 0; g < 255; g++) d.LOG_TABLE[d.EXP_TABLE[g]] = g;
            r.prototype = {
                get: function(t) {
                    return this.num[t]
                },
                ...
                multiply: function(t) {
                    for (var e = new Array(this.getLength() + t.getLength() - 1), o = 0; o < this.getLength(); o++) for (var n = 0; n < t.getLength(); n++) e[o + n] ^= d.gexp(d.glog(this.get(o)) + d.glog(t.get(n)));
                    return new r(e, 0)
                },
                mod: function(t) {
            ...
            n.getRSBlocks = function(t, e) {
                ...
                i = [], a = 0; a < o; a++) for (var s = r[3 * a + 0], u = r[3 * a + 1], h = r[3 * a + 2], l = 0; l < s; l++) i.push(new n(u, h));
                return i
            },
            ...
            function() {
                ...
                if (r && r <= 2.1) {
                    ...
                    CanvasRenderingContext2D.prototype.drawImage = function(t, e, r, i, a, s, u, h, l) {
                        if ("nodeName" in t && /img/i.test(t.nodeName)) for (var f = arguments.length - 1; f >= 1; f--) arguments[f] = arguments[f] * o;
                ...
                return i.prototype.draw = function(t) {
                    ...
                    this.clear();
                    for (var h = 0; h < n; h++) for (var l = 0; l < n; l++) {
                        var f = t.isDark(h, l),
                        c = l * i,
                        d = h * a;
                        ...
                        r.fillRect(c, d, i, a),
                        r.strokeRect(Math.floor(c) + .5, Math.floor(d) + .5, s, u),
                        r.strokeRect(Math.ceil(c) - .5, Math.ceil(d) - .5, s, u)
                    }
                    this._bIsPainted = !0
                },
                ...
                return t.prototype.draw = function(t) {
                    ...
                    r = this._el,
                    o = t.getModuleCount(), n = Math.floor(e.width / o), i = Math.floor(e.height / o), a = ['<table style="border:0;border-collapse:collapse;">'], s = 0; s < o; s++) {
                        a.push("<tr>");
                        for (var u = 0; u < o; u++) a.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + n + "px;height:" + i + "px;background-color:" + (t.isDark(s, u) ? e.colorDark: e.colorLight) + ';"></td>');
                        a.push("</tr>")
                    }
                    a.push("</table>"),
                    r.innerHTML = a.join("");
                    var h = r.childNodes[0],
                    l = (e.width - h.offsetWidth) / 2,
                    f = (e.height - h.offsetHeight) / 2;
                    l > 0 && f > 0 && (h.style.margin = f + "px " + l + "px")
                },
                t.prototype.clear = function() {
                    this._el.innerHTML = ""
                },
    ...
    default($(".qrcode")[0], {
        ...
        f = function(t) {
            $.ajax({
                ...
                dataType: "json",
                success: function(e) {
                    50001 == e.errcode || (50002 == e.errcode ? ($(".qrcodeLogin").hide(), $(".loginStatus_success").show()) : 50003 == e.errcode ? (clearInterval(l), $(".qrcodeLogin, .loginStatus_success").hide(), $(".loginStatus_error").show()) : 0 == e.errcode ? (clearInterval(l), h(t, e.data.loginid)) : $.dialogFull.Tips(e.errmsg))
                },
                error: function() {
                    $.dialogFull.Tips("网络错误，请稍后重试")
                }
        ...
        2e3),
        $(".content_box").on("click", ".loginType",
        function() {
            var t = $(this),
            e = t.data("type"),
            r = "passwordLogin" === e ? ".qrcodeLogin": ".passwordLogin";
            t.parent().slideUp(),
            $(r).slideDown(),
            ".qrcodeLogin" === r ? (clearInterval(l), l = setInterval(function() {
                f(u)
            },
            2e3)) : clearInterval(l)
        ...
        function() {
            var t = $.form.get();
            t && (t.password = (0, i.
        default)(t.password), $.form.submit({
                data: t,
                success: function(t) {
        ...
        }).on("click", ".loginStatus_error .btn",
        function() {
    ...
    36 : function(t, e, r) {
        ...
        function n(t, e) {
            ...
            f = 0; f < t.length; f += 16) {
                ...
                g = n,
                p = i;
                r = a(r, o, n, i, t[f + 0], 7, -680876936),
                i = a(i, r, o, n, t[f + 1], 12, -389564586),
                n = a(n, i, r, o, t[f + 2], 17, 606105819),
                o = a(o, n, i, r, t[f + 3], 22, -1044525330),
                r = a(r, o, n, i, t[f + 4], 7, -176418897),
                i = a(i, r, o, n, t[f + 5], 12, 1200080426),
                n = a(n, i, r, o, t[f + 6], 17, -1473231341),
                o = a(o, n, i, r, t[f + 7], 22, -45705983),
                r = a(r, o, n, i, t[f + 8], 7, 1770035416),
                i = a(i, r, o, n, t[f + 9], 12, -1958414417),
                n = a(n, i, r, o, t[f + 10], 17, -42063),
                o = a(o, n, i, r, t[f + 11], 22, -1990404162),
                r = a(r, o, n, i, t[f + 12], 7, 1804603682),
                i = a(i, r, o, n, t[f + 13], 12, -40341101),
                n = a(n, i, r, o, t[f + 14], 17, -1502002290),
                o = a(o, n, i, r, t[f + 15], 22, 1236535329),
                r = s(r, o, n, i, t[f + 1], 5, -165796510),
                i = s(i, r, o, n, t[f + 6], 9, -1069501632),
                n = s(n, i, r, o, t[f + 11], 14, 643717713),
                o = s(o, n, i, r, t[f + 0], 20, -373897302),
                r = s(r, o, n, i, t[f + 5], 5, -701558691),
                i = s(i, r, o, n, t[f + 10], 9, 38016083),
                n = s(n, i, r, o, t[f + 15], 14, -660478335),
                o = s(o, n, i, r, t[f + 4], 20, -405537848),
                r = s(r, o, n, i, t[f + 9], 5, 568446438),
                i = s(i, r, o, n, t[f + 14], 9, -1019803690),
                n = s(n, i, r, o, t[f + 3], 14, -187363961),
                o = s(o, n, i, r, t[f + 8], 20, 1163531501),
                r = s(r, o, n, i, t[f + 13], 5, -1444681467),
                i = s(i, r, o, n, t[f + 2], 9, -51403784),
                n = s(n, i, r, o, t[f + 7], 14, 1735328473),
                o = s(o, n, i, r, t[f + 12], 20, -1926607734),
                r = u(r, o, n, i, t[f + 5], 4, -378558),
                i = u(i, r, o, n, t[f + 8], 11, -2022574463),
                n = u(n, i, r, o, t[f + 11], 16, 1839030562),
                o = u(o, n, i, r, t[f + 14], 23, -35309556),
                r = u(r, o, n, i, t[f + 1], 4, -1530992060),
                i = u(i, r, o, n, t[f + 4], 11, 1272893353),
                n = u(n, i, r, o, t[f + 7], 16, -155497632),
                o = u(o, n, i, r, t[f + 10], 23, -1094730640),
                r = u(r, o, n, i, t[f + 13], 4, 681279174),
                i = u(i, r, o, n, t[f + 0], 11, -358537222),
                n = u(n, i, r, o, t[f + 3], 16, -722521979),
                o = u(o, n, i, r, t[f + 6], 23, 76029189),
                r = u(r, o, n, i, t[f + 9], 4, -640364487),
                i = u(i, r, o, n, t[f + 12], 11, -421815835),
                n = u(n, i, r, o, t[f + 15], 16, 530742520),
                o = u(o, n, i, r, t[f + 2], 23, -995338651),
                r = h(r, o, n, i, t[f + 0], 6, -198630844),
                i = h(i, r, o, n, t[f + 7], 10, 1126891415),
                n = h(n, i, r, o, t[f + 14], 15, -1416354905),
                o = h(o, n, i, r, t[f + 5], 21, -57434055),
                r = h(r, o, n, i, t[f + 12], 6, 1700485571),
                i = h(i, r, o, n, t[f + 3], 10, -1894986606),
                n = h(n, i, r, o, t[f + 10], 15, -1051523),
                o = h(o, n, i, r, t[f + 1], 21, -2054922799),
                r = h(r, o, n, i, t[f + 8], 6, 1873313359),
                i = h(i, r, o, n, t[f + 15], 10, -30611744),
                n = h(n, i, r, o, t[f + 6], 15, -1560198380),
                o = h(o, n, i, r, t[f + 13], 21, 1309151649),
                r = h(r, o, n, i, t[f + 4], 6, -145523070),
                i = h(i, r, o, n, t[f + 11], 10, -1120210379),
                n = h(n, i, r, o, t[f + 2], 15, 718787259),
                o = h(o, n, i, r, t[f + 9], 21, -343485551),
                r = l(r, c),
                o = l(o, d),
                n = l(n, g),
                i = l(i, p)
        ...
        function i(t, e, r, o, n, i) {
            return l(f(l(l(e, t), l(o, i)), n), r)
        }
        function a(t, e, r, o, n, a, s) {
            return i(e & r | ~e & o, t, e, n, a, s)
        }
        function s(t, e, r, o, n, a, s) {
            return i(e & o | r & ~o, t, e, n, a, s)
        }
        function u(t, e, r, o, n, a, s) {
            return i(e ^ r ^ o, t, e, n, a, s)
        }
        function h(t, e, r, o, n, a, s) {
            return i(r ^ (e | ~o), t, e, n, a, s)
        }
        function l(t, e) {
        ...
        function c(t) {
            for (var e = Array(), r = (1 << p) - 1, o = 0; o < t.length * p; o += p) e[o >> 5] |= (t.charCodeAt(o / p) & r) << o % 32;
            return e
        }
        function d(t) {
            for (var e = g ? "0123456789ABCDEF": "0123456789abcdef", r = "", o = 0; o < 4 * t.length; o++) r += e.charAt(t[o >> 2] >> o % 4 * 8 + 4 & 15) + e.charAt(t[o >> 2] >> o % 4 * 8 & 15);
            return r
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
