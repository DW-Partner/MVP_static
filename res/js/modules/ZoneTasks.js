...
!function(e){function a(s){if(t[s])return t[s].exports;var n=t[s]={i:s,l:!1,exports:{}};return e[s].call(n.exports,n,n.exports,a),n.l=!0,n.exports}var t={};a.m=e,a.c=t,a.d=function(e,t,s){a.o(e,t)||Object.defineProperty(e,t,{configurable:!1,enumerable:!0,get:s})},a.n=function(e){var t=e&&e.__esModule?function(){return e.default}:function(){return e};return a.d(t,"a",t),t},a.o=function(e,a){return Object.prototype.hasOwnProperty.call(e,a)},a.p="/",a(a.s=257)}({257:function(e,a,t){"use strict";var s=t(9);!function(e){e&&e.__esModule}(s);t(258);var n=$('#main_box input').eq(0).val(),o={ZoneTasks:'<li>\t<div class="item"><p><span>{time}</span></p></div>\t<div class="item"><p><span>{from}</span></p></div>\t<div class="item"><p><span>{content}</span></p></div>\t<div class="item"><p><span><input type="checkbox" name="id_{task_id}" {checked} {status} data-taskid={task_id}></span></p></div>\t</li>',MsgFromSchool:'<li>\t<div class="item"><p><span>{time}</span></p></div>\t<div class="item"><p><span>{from}</span></p></div>\t<div class="item"><p><span>{content}</span></p></div>\t<div class="item"><p><span><input type="checkbox" name="id_{msg_id}" {checked} {status} data-msgid={msg_id}></span></p></div>\t</li>',SendList:'<li>\t<div class="item"><p><span>{time}</span></p></div>\t<div class="item"><p><span>{to}</span></p></div>\t<div class="item"><p><span>{content}</span></p></div>\t</li>'};
