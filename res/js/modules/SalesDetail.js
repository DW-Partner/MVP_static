...
function(t) {
    ...
    182 : function(t, e, r) {
        ...
        var n = function(t) {
            ...
            return e = $.extend(e, t),
            $(e.nav).eq(e.show_index).addClass(e.nav_on_class),
            $(e.content).hide().eq(e.show_index).show(),
            e.tab_box.on(e.event, e.nav,
            function() {
                var t = $(e.nav).index(this);
                $(this).addClass(e.nav_on_class).siblings(e.nav).removeClass(e.nav_on_class),
                $(e.content).eq(t).show().siblings(e.content).hide()
            }),
            {
                distory: function() {
                    e.tab_box.off(e.event, e.nav)
                }
            }
        };
        e.
    ...
    225 : function(t, e, r) {
        ...
        r(226);
        var l = {
            base_info: "<p><span>教师姓名：</span><em>{name}</em></p>\t\t\t\t<p><span>性别：</span><em>{gender}</em></p>\t\t\t\t<p><span>出生日期：</span><em>{birthday}</em></p>\t\t\t\t<p><span>入职时间：</span><em>{entry_day}</em></p>\t\t\t\t<br />\t\t\t\t<p><span>详细地址：</span><em>{address}</em></p>\t\t\t\t<p><span>手机号：</span><em>{mobile}</em></p>\t\t\t\t<br /><p><span>身份证号：</span><em>{id_num}</em></p>\t\t\t\t<p><span>毕业学历信息：</span><em>{education}</em></p>"
        },
        u = $("#salesid").val(),
        f = function(t) {
            $.ajax({
                ...
                success: function(e) {
                    if (0 != e.errcode) return void $.dialogFull.Tips(e.errmsg);
                    $("#img_box").html(""),
                    new i.
                default($("#img_box")[0], {
                        text: "your content",
                        ...
                        colorDark: "#000000",
                        colorLight: "#ffffff"
                    }).makeCode(e.data.qrcode),
                    t && $.dialogFull.Tips("更新成功！")
                },
                error: function() {
        ...
        function() {
            $.ajax({
                ...
                success: function(t) {
                    ...
                    var e = (0, s.
                default)(l.base_info, t.data);
                    $(".TeacherDetail .center").html(e),
                    f()
                },
                error: function() {
                    $.dialogFull.Tips("网络错误，请稍后重试！")
        ...
        function() {
            function t(t) {
                ...
                r = this.data.length; e < r; e++) {
                    ...
                    o > 65536 ? (n[0] = 240 | (1835008 & o) >>> 18, n[1] = 128 | (258048 & o) >>> 12, n[2] = 128 | (4032 & o) >>> 6, n[3] = 128 | 63 & o) : o > 2048 ? (n[0] = 224 | (61440 & o) >>> 12, n[1] = 128 | (4032 & o) >>> 6, n[2] = 128 | 63 & o) : o > 128 ? (n[0] = 192 | (1984 & o) >>> 6, n[1] = 128 | 63 & o) : n[0] = o,
            ...
            e.prototype = {
                ...
                getBestMaskPattern: function() {
                    ...
                    r = 0; r < 8; r++) {
                        this.makeImpl(!0, r);
                        var n = c.getLostPoint(this); (0 == r || t > n) && (t = n, e = r)
                    }
                    return e
                },
                createMovieClip: function(t, e, r) {
                    ...
                    this.make();
                    for (var o = 0; o < this.modules.length; o++) for (var i = 1 * o,
                    a = 0; a < this.modules[o].length; a++) {
                        var s = 1 * a,
                        h = this.modules[o][a];
                        h && (n.beginFill(0, 100), n.moveTo(s, i), n.lineTo(s + 1, i), n.lineTo(s + 1, i + 1), n.lineTo(s, i + 1), n.endFill())
                    }
                    return n
                },
                ...
                setupTypeInfo: function(t, e) {
                    ...
                    n = c.getBCHTypeInfo(r), o = 0; o < 15; o++) {
                        var i = !t && 1 == (n >> o & 1);
                ...
                mapData: function(t, e) {
                    ...
                    a = this.moduleCount - 1; a > 0; a -= 2) for (6 == a && a--;;) {
                        for (var s = 0; s < 2; s++) if (null == this.modules[n][a - s]) {
                            var h = !1;
                            i < t.length && (h = 1 == (t[i] >>> o & 1));
                            var l = c.getMask(e, n, a - s);
                            l && (h = !h),
                            this.modules[n][a - s] = h,
                            o--,
                            -1 == o && (i++, o = 7)
                        }
            ...
            e.createBytes = function(t, e) {
                ...
                a = new Array(e.length), s = new Array(e.length), h = 0; h < e.length; h++) {
                    ...
                    i = Math.max(i, u),
                    a[h] = new Array(l);
                    for (var f = 0; f < a[h].length; f++) a[h][f] = 255 & t.buffer[f + n];
                    n += l;
                    var d = c.getErrorCorrectPolynomial(u),
                    g = new r(a[h], d.getLength() - 1),
                    p = g.mod(d);
                    s[h] = new Array(d.getLength() - 1);
                    for (var f = 0; f < s[h].length; f++) {
                        var v = f + p.getLength() - s[h].length;
                        s[h][f] = v >= 0 ? p.get(v) : 0
                    }
                }
                for (var m = 0,
                f = 0; f < e.length; f++) m += e[f].totalCount;
                for (var _ = new Array(m), C = 0, f = 0; f < o; f++) for (var h = 0; h < e.length; h++) f < a[h].length && (_[C++] = a[h][f]);
                for (var f = 0; f < i; f++) for (var h = 0; h < e.length; h++) f < s[h].length && (_[C++] = s[h][f]);
                return _
            };
            for (var l = {
                MODE_NUMBER: 1,
            ...
            c = {
                ...
                getErrorCorrectPolynomial: function(t) {
                    for (var e = new r([1], 0), n = 0; n < t; n++) e = e.multiply(new r([1, d.gexp(n)], 0));
                    return e
                },
                ...
                getLostPoint: function(t) {
                    for (var e = t.getModuleCount(), r = 0, n = 0; n < e; n++) for (var o = 0; o < e; o++) {
                        for (var i = 0,
                        a = t.isDark(n, o), s = -1; s <= 1; s++) if (! (n + s < 0 || e <= n + s)) for (var h = -1; h <= 1; h++) o + h < 0 || e <= o + h || 0 == s && 0 == h || a == t.isDark(n + s, o + h) && i++;
                        i > 5 && (r += 3 + i - 5)
                    }
                    for (var n = 0; n < e - 1; n++) for (var o = 0; o < e - 1; o++) {
                        var l = 0;
                        t.isDark(n, o) && l++,
                        t.isDark(n + 1, o) && l++,
                        t.isDark(n, o + 1) && l++,
                    ...
                    for (var n = 0; n < e; n++) for (var o = 0; o < e - 6; o++) t.isDark(n, o) && !t.isDark(n, o + 1) && t.isDark(n, o + 2) && t.isDark(n, o + 3) && t.isDark(n, o + 4) && !t.isDark(n, o + 5) && t.isDark(n, o + 6) && (r += 40);
                    for (var o = 0; o < e; o++) for (var n = 0; n < e - 6; n++) t.isDark(n, o) && !t.isDark(n + 1, o) && t.isDark(n + 2, o) && t.isDark(n + 3, o) && t.isDark(n + 4, o) && !t.isDark(n + 5, o) && t.isDark(n + 6, o) && (r += 40);
                    for (var u = 0,
                    o = 0; o < e; o++) for (var n = 0; n < e; n++) t.isDark(n, o) && u++;
            ...
            r.prototype = {
                ...
                multiply: function(t) {
                    for (var e = new Array(this.getLength() + t.getLength() - 1), n = 0; n < this.getLength(); n++) for (var o = 0; o < t.getLength(); o++) e[n + o] ^= d.gexp(d.glog(this.get(n)) + d.glog(t.get(o)));
                    return new r(e, 0)
                },
                mod: function(t) {
                    if (this.getLength() - t.getLength() < 0) return this;
                    for (var e = d.glog(this.get(0)) - d.glog(t.get(0)), n = new Array(this.getLength()), o = 0; o < this.getLength(); o++) n[o] = this.get(o);
                    for (var o = 0; o < t.getLength(); o++) n[o] ^= d.gexp(d.glog(t.get(o)) + e);
            ...
            o.getRSBlocks = function(t, e) {
                ...
                i = [], a = 0; a < n; a++) for (var s = r[3 * a + 0], h = r[3 * a + 1], l = r[3 * a + 2], u = 0; u < s; u++) i.push(new o(h, l));
                return i
            },
            ...
            v = function() {
                ...
                return t.prototype.draw = function(t) {
                    function e(t, e) {
                        ...
                        for (var n in e) e.hasOwnProperty(n) && r.setAttribute(n, e[n]);
                        return r
                    }
            ...
            function() {
                ...
                if (r && r <= 2.1) {
                    ...
                    CanvasRenderingContext2D.prototype.drawImage = function(t, e, r, i, a, s, h, l, u) {
                        if ("nodeName" in t && /img/i.test(t.nodeName)) for (var f = arguments.length - 1; f >= 1; f--) arguments[f] = arguments[f] * n;
                        else void 0 === l && (arguments[1] *= n, arguments[2] *= n, arguments[3] *= n, arguments[4] *= n);
                ...
                return i.prototype.draw = function(t) {
                    ...
                    this.clear();
                    for (var l = 0; l < o; l++) for (var u = 0; u < o; u++) {
                        var f = t.isDark(l, u),
                        c = u * i,
                        d = l * a;
                        r.strokeStyle = f ? n.colorDark: n.colorLight,
                        r.lineWidth = 1,
                        r.fillStyle = f ? n.colorDark: n.colorLight,
                        r.fillRect(c, d, i, a),
                        r.strokeRect(Math.floor(c) + .5, Math.floor(d) + .5, s, h),
                        r.strokeRect(Math.ceil(c) - .5, Math.ceil(d) - .5, s, h)
                    }
                    this._bIsPainted = !0
                },
                ...
                return t.prototype.draw = function(t) {
                    ...
                    r = this._el,
                    n = t.getModuleCount(), o = Math.floor(e.width / n), i = Math.floor(e.height / n), a = ['<table style="border:0;border-collapse:collapse;">'], s = 0; s < n; s++) {
                        a.push("<tr>");
                        for (var h = 0; h < n; h++) a.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + o + "px;height:" + i + "px;background-color:" + (t.isDark(s, h) ? e.colorDark: e.colorLight) + ';"></td>');
                        a.push("</tr>")
                    }
                    a.push("</table>"),
                    r.innerHTML = a.join("");
