...
<head>
    ...
    <link href="/res/css/modules/ZoneLogin.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="layout_center">
        <div class="content_box">
            ...
            <!-- 扫描登录end -->
            <!-- 账号密码登录start -->
            <div class="passwordLogin"> <a href="JavaScript:;" class="loginType" data-type="passwordLogin"></a>
                <h5>密码登录</h5>
                <div class="pub_form">
                    <ul>
                        <li> <input type="text" name="jigou" data-validate="number" data-must="1" placeholder="机构代码"> </li>
                        <li> <input type="text" name="userId" data-validate="number" data-must="1" placeholder="账号"> </li>
            ...
            <div class="loginStatus_error none">
                <p>二维码已失效</p> <a href="JavaScript:;" class="btn">刷新二维码</a> </div>
            <!-- 扫描失败end -->
        </div>
    </div>
    ...
    <script type="text/javascript" src="/res/js/modules/ZoneLogin.js"></script>
</body>
